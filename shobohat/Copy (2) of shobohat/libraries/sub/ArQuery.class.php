...
class ArQuery
{
    ...
    protected $lexPatterns     = array();
    protected $lexReplacements = array();

    /**
     * "getWhereCondition" method output charset
     * @var String     
     */         
    public $getWhereConditionOutput = 'windows-1256';

    /**
     * "getWhereCondition" method input charset
     * @var String     
     */         
    public $getWhereConditionInput = 'windows-1256';

    /**
     * Name of the textual "getWhereCondition" method parameters 
     * @var Array     
     */         
    public $getWhereConditionVars = array('arg');

    /**
     * "getOrderBy" method output charset
     * @var String     
     */         
    public $getOrderByOutput = 'windows-1256';

    /**
     * "getOrderBy" method input charset
     * @var String     
     */         
    public $getOrderByInput = 'windows-1256';

    /**
     * Name of the textual "getOrderBy" method parameters 
     * @var Array     
     */         
    public $getOrderByVars = array('arg');

    /**
     * "allForms" method output charset
     * @var String     
     */         
    public $allFormsOutput = 'windows-1256';

    /**
     * "allForms" method input charset
     * @var String     
     */         
    public $allFormsInput = 'windows-1256';

    /**
     * Name of the textual "allForms" method parameters 
     * @var Array     
     */         
    public $allFormsVars = array('arg');
    ...
    public function __construct()
    {
        ...
        foreach ($xml->xpath("//preg_replace[@function='__construct']/pair")
                 as $pair) { 
            $search  = iconv("utf-8", "cp1256//TRANSLIT", (string)$pair->search);
            $replace = iconv("utf-8", "cp1256//TRANSLIT", (string)$pair->replace);

            array_push($this->lexPatterns, $search); 
            array_push($this->lexReplacements, $replace); 
        }
    }
    ...
    protected function getWordRegExp($arg)
    {
        ...
        $sql = ' REPLACE(' . 
               implode(", 'ـ', '') REGEXP '$arg' OR REPLACE(", $this->fields) . 
               ", 'ـ', '') REGEXP '$arg'";
    ...
    {
        $arg = preg_replace($this->lexPatterns, $this->lexReplacements, $arg);
